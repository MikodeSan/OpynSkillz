...
urlpatterns = [
    ...
    path('channel/path/new', views.path_initialize, name='path_new'),
    path('channel/path/create', views.path_create, name='path_create'), # path_new
    path('channel/design/path/<int:path_id>', views.path_design, name='path_design'),
